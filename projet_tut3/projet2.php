...
echo'
    ...
    <div class="rer0">
        ...
        <!-- header -->
        <p class="cv">Nos CV</p>  
        <p class="contact">Conctact</p>
        <p class="aide">?</p>
        <!-- logo -->
        <img class="logo" src="logommi/logo.png" alt="">
    ...
    <div style="position: relative">
        ...
        <img src="railrouge2.png" class="railrouge2" alt="">
        <p class="pointnr p1"></p>
        <p class="pointn2r p1"></p>
        <p class="pointn3r p1"></p>
        <p class="pointn4r p1"></p>
        <p class="pointn5r p1"></p>   
        <p class="pointn6r p1"></p>
        <p class="pointb1r"></p>
        <p class="pointb2r"></p>
        <p class="pointb3r"></p>
        <p class="pointb4r"></p>
        <p class="pointb5r"></p>
        <p class="pointb6r"></p>
        <p class="marketing domaine p1">MARKETING</p>
        <p class="communication domaine p1">COMMUNICATION</p>
        <p class="audiovisuel domaine p1">AUDIOVISUEL</p>
        <p class="gestion domaine p1">GESTION <br>DE PROJET</p>
        <p class="infographie domaine p1">INFOGRAPHIE</p>
        <p class="graphisme domaine p1">GRAPHISME</p>
    </div>
    </div>
    <!-- rer2 -->
    <div class="rer2">
    ...
    <div class="rails" style="position: relative">
        <img src="railbleu2.png" class="railbleu2" alt="">
        <p class="pointnb p2" ></p>
        <p class="pointn2b p2"></p>
        <p class="pointn3b p2"></p>
        <p class="pointn4b p2"></p>
        <p class="pointn5b p2"></p>
        <p class="pointb1b"></p>
        <p class="pointb2b"></p>
        <p class="pointb3b"></p>
        <p class="pointb4b"></p>
    ...
    <div class="rer3">
        ...
        <div  class="rails" style="position: relative">
            <img src="railrouge3bas.png" class="railrouge3bas" alt="">
        </div>
        <div  class="rails" style="position: relative">
            <img src="railrouge3haut.png" class="railrouge3haut" alt="">
        </div>
        <button class="bouton3">LICENCES PRO</button>
        <button class="bouton4">ÉCOLES</button>
    </div>
    ...
    <div class="rer4">
        ...
        <div  class="rails" style="position: relative">
            <img src="railbleu3bas.png" class="railbleu3bas" alt="">
        </div>
        <div  class="rails" style="position: relative">
            <img src="railbleu3haut.png" class="railbleu3haut" alt="">
        </div>
        <button class="bouton5">LICENCES PRO</button>
        <button class="bouton6">ÉCOLES</button>
    </div>
    ...
    <a href="" class="cv1julie">CV papier</a>
    <a href="" class="cv2julie">CV interactif</a>
    <p class="manar">Manar BASSIMANE</p>
    <a href="" class="cv1manar">CV papier</a>
    <a href="" class="cv2manar">CV interactif</a>
    <p class="stef">Stef MILLS</p>
    <a href="" class="cv1stef">CV papier</a>
    <a href="" class="cv2stef">CV interactif</a>
    <p class="yasmine">Yasmine KOURICHI</p>
    <a href="" class="cv1yasmine">CV papier</a>
    ...
    <div class="rer3ecole">
        ...
        <div  class="rails" style="position: relative">
            <img src="railjaune.png" class="railjaune" alt="">
        </div>
    </div>
    </div>
    <div class="rer3licence">
        <div  style="position: relative;">
